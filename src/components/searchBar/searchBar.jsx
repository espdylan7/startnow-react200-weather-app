...
export default class SearchBar extends React.Component {
    ...
    return (
        ...
        <div className="container">
          <ul className="nav nav-tabs">
            <li>
              <button className="btn btn-primary" id="a-one-tag"
              name="city"
              value="San Diego"
            ...
            <li>
            <button className="btn btn-primary" id="a-two-tag"
            name="city"
            value="New York"
            onClick={this.handleCity}>
              New York
            ...
            <li>
              <button className="btn btn-primary" id="a-three-tag"
              name="city"
            ...
            <li>
              <button className="btn btn-primary" id="a-four-tag"
              name="city"
              value="London"
              onClick={this.handleCity}>
                London
            ...
            <li>
              <button className="btn btn-primary" id="a-five-tag"
              name="city"
              value="Tokyo"
              onClick={this.handleCity}>
  ...
  <div className="input-group-append">
    <button className="btn btn-primary" id="basic-addon2">Search</button>
  </div>
</div>
